...
- VMware Fusion on Apple Silicon uses Apple's vmnet.framework, which hides
  VM-to-VM traffic from BPF (the kernel facility tcpdump and Wireshark use).
  Packet capture must be done on the source VM (Kali eth0) — documented in
  incident 003.
