...
|---|----------|-----------|-------|
| 001 | [Brute Force Detection](incidents/incident-001-bruteforce/incident-001-bruteforce.md) | PowerShell credential stuffing → EventCode 4625 → Splunk Alert | T1110.004 |
| 002 | [Nmap Port Scan Detection](incidents/incident-002-nmap-scan/incident-002-nmap-scan.md) | Kali TCP connect scan → Sysmon EventID 3 → Splunk SPL | T1046 |
| 003 | [Wireshark Packet Capture](incidents/incident-003-wireshark/incident-003.md) | Slow nmap -T1 scan → tcpdump on attacker NIC → Wireshark analysis | T1046 |
...
- [003 — Wireshark Packet Capture](incidents/incident-003-wireshark/incident-003.md)
