...
This repository documents practical cybersecurity lab work focused on attack simulation, Windows logging, Splunk detection engineering, packet analysis, and cloud security lab development.
...
- VMware NAT routing means Kali traffic appears as Mac host IP in Windows logs, which is documented as a real-world NAT attribution challenge.
- VMware Fusion on Apple Silicon uses Apple's vmnet.framework, which hides VM-to-VM traffic from BPF, the kernel facility used by tcpdump and Wireshark.
- Packet capture must be done on the source VM, such as Kali eth0, as documented in incident 003.
- Splunk minFreeSpace was tuned for home lab disk constraints.
